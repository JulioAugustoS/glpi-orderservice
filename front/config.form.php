...
if ($_SESSION["glpiactiveprofile"]["interface"] == "central") {
    Html::header(PluginOrderServiceDisplay::getTypeName(1), $_SERVER['PHP_SELF'], "plugins", "orderservice", "");
}else{
    Html::helpHeader(PluginOrderServiceDisplay::getTypeName(1), $_SERVER['PHP_SELF']);
}
  
PluginOrderServiceDisplay::displayTelaConfig();
